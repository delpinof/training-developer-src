...
public class ShakespeareValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2785770081176539923L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ShakespeareValue\",\"namespace\":\"solution.model\",\"fields\":[{\"name\":\"line_number\",\"type\":\"int\",\"doc\":\"The line number for line\"},{\"name\":\"line\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"The line from Shakespeare\"}]}");
   ...
   */
  public ShakespeareValue(Integer line_number, String line) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: line_number = (Integer)value$; break;
    case 1: line = (String)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @return A new ShakespeareValue RecordBuilder
   */
  public static Builder newBuilder(ShakespeareValue other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShakespeareValue>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ShakespeareValue other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.line_number)) {
        this.line_number = data().deepCopy(fields()[0].schema(), other.line_number);
        fieldSetFlags()[0] = true;
    ...
    public ShakespeareValue build() {
      try {
        ...
        record.line_number = fieldSetFlags()[0] ? this.line_number : (Integer) defaultValue(fields()[0]);
        record.line = fieldSetFlags()[1] ? this.line : (String) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
