...
public class ShakespeareKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9050998639605855239L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ShakespeareKey\",\"namespace\":\"solution.model\",\"fields\":[{\"name\":\"work\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"The name of the work\"},{\"name\":\"year\",\"type\":\"int\",\"doc\":\"The year the work was published\"}]}");
   ...
   */
  public ShakespeareKey(String work, Integer year) {
    this.work = work;
    this.year = year;
  }
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: work = (String)value$; break;
    case 1: year = (Integer)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @return A new ShakespeareKey RecordBuilder
   */
  public static Builder newBuilder(ShakespeareKey other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ShakespeareKey>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ShakespeareKey other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.work)) {
        this.work = data().deepCopy(fields()[0].schema(), other.work);
        fieldSetFlags()[0] = true;
    ...
    public ShakespeareKey build() {
      try {
        ...
        record.work = fieldSetFlags()[0] ? this.work : (String) defaultValue(fields()[0]);
        record.year = fieldSetFlags()[1] ? this.year : (Integer) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
